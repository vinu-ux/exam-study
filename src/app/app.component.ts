...
export class AppComponent implements AfterViewInit {
  ...
  addMarker(x: number, y: number) {
    ...
    marker.on('mouseover', () => {
      // Show tooltip only
      this.tooltipHeader = (marker as any).header || '';
      this.tooltipComment = (marker as any).comment || '';
      this.tooltipLeft = marker.left! + 25;
      this.tooltipTop = marker.top! - 10;
  ...
  submitComment() {
    if (this.currentMarker) {
      ...
      this.tooltipHeader = this.inputHeader;
      this.tooltipComment = this.inputComment;
      this.tooltipLeft = this.currentMarker.left! + 25;
      this.tooltipTop = this.currentMarker.top! - 10;
      this.tooltipMarker = this.currentMarker;
      this.showTooltip = true;
      this.showInput = false;
